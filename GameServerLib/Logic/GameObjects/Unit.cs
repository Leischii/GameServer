...
namespace LeagueSandbox.GameServer.Logic.GameObjects
{
    ...
    public class Unit : GameObject
    {
        ...
        public override void update(float diff)
        {
            ...
            var onUpdate = _scriptEngine.GetStaticMethod<Action<double>>(Model, "Passive", "OnUpdate");
        ...
        public override void onCollision(GameObject collider)
        {
            ...
            if (collider == null)
            {
                var onCollideWithTerrain = _scriptEngine.GetStaticMethod<Action>(Model, "Passive", "onCollideWithTerrain");
                onCollideWithTerrain?.Invoke();
            }
            else
            {
                var onCollide = _scriptEngine.GetStaticMethod<Action<Unit>>(Model, "Passive", "onCollide");
                onCollide?.Invoke(collider as Unit);
            }
        }
        ...
        public virtual void AutoAttackHit(Unit target)
        {
            ...
            var onAutoAttack = _scriptEngine.GetStaticMethod<Action<Unit>>(Model, "Passive", "OnAutoAttack");
            onAutoAttack?.Invoke(target);
        ...
        public virtual void DealDamageTo(Unit target, float damage, DamageType type, DamageSource source, bool isCrit)
        {
            ...
            var onDamageTaken = target._scriptEngine.GetStaticMethod<Action<Unit, float, DamageType, DamageSource>>(Model, "Passive", "OnDamageTaken");
            var onDealDamage = _scriptEngine.GetStaticMethod<Action<Unit, float, DamageType, DamageSource>>(Model, "Passive", "OnDealDamage");

            //Damage dealing. (based on leagueoflegends' wikia)
            damage = defense >= 0 ? (100 / (100 + defense)) * damage : (2 - (100 / (100 - defense))) * damage;

            onDamageTaken?.Invoke(this, damage, type, source);
            onDealDamage?.Invoke(target, damage, type, source);
        ...
        public virtual void die(Unit killer)
        {
            ...
            var onDie = _scriptEngine.GetStaticMethod<Action<Unit>>(Model, "Passive", "OnDie");
            onDie?.Invoke(killer);
